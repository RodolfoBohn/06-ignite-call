...
export default function TimeIntervals() {
  const {
    ...
    defaultValues: {
      intervals: [
        ...
        { weekDay: 5, enabled: true, startTime: '11:00', endTime: '18:00' },
  ...
  async function handleSetTymeIntervals(data: any) {
  ...
  return (
    <Container>
      ...
      <IntervalBox as="form" onSubmit={handleSubmit(handleSetTymeIntervals)}>
        <IntervalContainer>
          {fields.map((field) => {
            return (
